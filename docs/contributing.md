...
- **P2P message testing**: See the scoped
  [GetBlocks property-testing pilot](testing/p2p-message-property-testing.md) for
  an example of independent wire-contract evidence

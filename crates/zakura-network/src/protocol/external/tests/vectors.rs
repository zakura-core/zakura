...
fn parses_msg_addr_v1_ip() {
    ...
    for (case_idx, addr_v1_bytes) in zakura_test::network_addr::ADDR_V1_IP_VECTORS
        .iter()
        .enumerate()
    {
...
fn parses_msg_addr_v1_empty() {
    ...
    for (case_idx, addr_v1_bytes) in zakura_test::network_addr::ADDR_V1_EMPTY_VECTORS
        .iter()
        .enumerate()
    {
        let deserialized: Message = codec
...
fn parses_msg_addr_v2_ip() {
    ...
    for (case_idx, addr_v2_bytes) in zakura_test::network_addr::ADDR_V2_IP_VECTORS
        .iter()
        .enumerate()
    {
        let deserialized: Message = codec
...
fn parses_msg_addr_v2_empty() {
    ...
    for (case_idx, addr_v2_bytes) in zakura_test::network_addr::ADDR_V2_EMPTY_VECTORS
        .iter()
        .enumerate()
    {
        let deserialized: Message = codec
...
fn parses_msg_addr_v2_invalid() {
    ...
    for (case_idx, addr_v2_bytes) in zakura_test::network_addr::ADDR_V2_INVALID_VECTORS
        .iter()
        .enumerate()
    {
        codec

...
| `changelog/params.md` | Parameter re-tunings (constants, defaults, timeouts, limits) | Reviewers and operators |

`changelog/params.md` is a compact ledger that complements the prose
...
is in
[`changelog/unreleased/README.md`](unreleased/README.md).
...
- A change to a tunable parameter gets a row in `changelog/params.md` _in

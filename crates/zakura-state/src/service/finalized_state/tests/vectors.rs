...
fn sprout_note_commitment_tree_serialization() {
    ...
    // Some commitments from zakura-chain/src/sprout/tests/test_vectors.rs
    let hex_commitments = [
...
fn sapling_note_commitment_tree_serialization() {
    ...
    // Some commitments from zakura-chain/src/sapling/tests/test_vectors.rs
    let hex_commitments = [
...
fn orchard_note_commitment_tree_serialization() {
    ...
    // Some commitments from zakura-chain/src/orchard/tests/tree.rs
    let commitments = [
        [

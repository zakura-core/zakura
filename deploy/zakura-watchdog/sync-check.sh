...
#
# The watchdog reads the same environment variables as
# deploy/zcashd-compat/sync-check.sh (ZAKURA_RPC_URL,
# ZAKURA_COOKIE_FILE, ZCASHD_RPC_URL, ZCASHD_COOKIE_FILE, HEIGHT_MAX_DRIFT,

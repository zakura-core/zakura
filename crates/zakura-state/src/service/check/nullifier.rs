...
use tracing::trace;
use zakura_chain::{ironwood, transaction::Transaction};
...
///   provided non-finalized [`Chain`] or [`ZakuraDb`].
///
/// # Consensus
///
/// > A nullifier MUST NOT repeat either within a transaction,
...
/// - from different `JoinSplit`s, [`sapling::Spend`](zakura_chain::sapling::Spend)s,
///   [`orchard::Action`](zakura_chain::orchard::Action)s, or Ironwood actions in
///   this [`Transaction`]'s shielded data, or
/// - one from this shielded data, and another from:
///   - a previous transaction in this [`Block`](zakura_chain::block::Block), or

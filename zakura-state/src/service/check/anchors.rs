...
fn sapling_orchard_ironwood_anchors_refer_to_final_treestates(
    ...
    // [`zakura_chain::sapling::shielded_data`].
    //
...
/// Accepts a [`ZakuraDb`], [`Chain`], and [`SemanticallyVerifiedBlock`].
///
...
/// Accepts a [`ZakuraDb`], [`Arc<Chain>`](Chain), and [`SemanticallyVerifiedBlock`].
///
...
/// Accepts a [`ZakuraDb`], [`Arc<Chain>`](Chain), [`Arc<Block>`](Block), and an
...
/// Accepts a [`ZakuraDb`], an optional [`Option<Arc<Chain>>`](Chain), and an [`UnminedTx`].
///

...
- [User Documentation](user.md)
  ...
  - [Zakura Health Endpoints](user/health.md)
  ...
  - [Mining](user/mining.md)
    ...
    - [Mining with Zakura in Docker](user/mining-docker.md)
  - [Kibana blockchain explorer](user/elasticsearch.md)
  - [zcashd-compat Mode](user/zcashd-compat.md)
  - [Forking the Zcash Testnet with Zakura](user/fork-zakura-testnet.md)
  - [Custom Testnets](user/custom-testnets.md)
    - [Regtest with Zakura](user/regtest.md)
...
- [Developer Documentation](dev.md)
  ...
  - [Diagrams](dev/diagrams.md)
    - [Network Architecture](dev/diagrams/zakura-network.md)
  ...
  - [Zakura crates](dev/crate-owners.md)

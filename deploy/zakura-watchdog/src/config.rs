...
pub struct Config {
    ...
    /// `pgrep -f` pattern that must match a running zakurad process.
    #[arg(
        global = true,
        long,
...
mod tests {
    ...
    fn defaults_match_sync_check_script() {
        ...
        assert_eq!(config.zakura_rpc_url, "http://127.0.0.1:8232");
    ...
    fn cli_flags_override_defaults() {
        ...
        assert_eq!(config.zakura_rpc_url, "http://127.0.0.1:18232");

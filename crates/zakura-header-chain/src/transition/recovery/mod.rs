...
/// The audit plans an atomic update when the trust-anchor manifest or diagnostic network
/// policy digest differs. A policy digest mismatch alone never rejects the store.
///

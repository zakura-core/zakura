//! Initialization and arbitrary data generation functions for zakura-state.
...
pub(crate) fn partial_nu5_chain_strategy(
    ...
    Value = (
        Network,
        Height,
        zakura_chain::fmt::SummaryDebug<Vec<Arc<Block>>>,
    ),
> {
    (
        any::<Network>(),
        ...
        .prop_flat_map(move |(network, random_nu)| {
            ...
            zakura_chain::block::LedgerState::height_strategy(
                height,
                Some(nu),

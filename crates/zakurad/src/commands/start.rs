...
impl StartCmd {
    ...
    pub(crate) async fn start(
        ...
        let consensus_read_state = read_only_state_service.clone();
        let consensus_init_task = tokio::spawn(zakura_consensus::router::init_with_read_state(
            consensus_config,
            network,
            consensus_state,
            consensus_read_state,

...
/// zakura-checkpoints --cli /path/to/zcash-cli --last-checkpoint "$LAST_CHECKPOINT" >> main-checkpoints.txt &
...
/// `zakura-checkpoints [other args] -- -testnet`.
///
/// See [`MAINNET_CHECKPOINTS`] for detailed `zakura-checkpoints` usage
/// information.
...
impl Network {
    ...
    pub fn genesis_hash(&self) -> block::Hash {
        match self {
            ...
            // See `zakura_chain::parameters::network::testnet` for more details.

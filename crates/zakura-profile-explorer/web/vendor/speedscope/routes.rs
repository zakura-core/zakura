...
match asset.as_str() {
    ...
    "chunk-KY5FQVXF.js" => ([(header::CONTENT_TYPE, "text/javascript")], include_bytes!("chunk-KY5FQVXF.js").as_slice()).into_response(),
    ...
    "import-L3I5W4LA.js" => ([(header::CONTENT_TYPE, "text/javascript")], include_bytes!("import-L3I5W4LA.js").as_slice()).into_response(),

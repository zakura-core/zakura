...
- Write configurations generated by `zakurad generate` atomically, preserving
  an existing output file if writing its replacement fails
  ([#325](https://github.com/zakura-core/zakura/pull/325)).

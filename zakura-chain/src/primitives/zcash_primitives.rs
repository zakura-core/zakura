...
impl PrecomputedTxData {
    ...
    /// tx verifier in `zakura-consensus`.
    ///
...
///   public callers in `zakura-chain` document this as a precondition.
...
///
/// All callers in `zakura-chain` unwrap the returned `Result` at the public

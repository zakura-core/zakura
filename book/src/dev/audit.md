...
In addition to our normal [release process](https://github.com/zakura-core/zakura/blob/main/book/src/dev/release-process.md), we do these steps to prepare for an audit:

...
//!
//! This empty integration test makes `cargo` build the `zakura-checkpoints` binary for the `zakurad`
//! integration tests:
//!
...
//!
//! When `cargo -Z bindeps` is stabilised, add a binary dependency to `zakurad/Cargo.toml` instead:

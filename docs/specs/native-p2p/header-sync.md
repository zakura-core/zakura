...
implementation in [`HeaderSyncMessage::check_payload_size`](https://github.com/zakura-core/zakura/blob/f892b9074002a04a678ef2365ec7658795796572/crates/zakura-network/src/zakura/header_sync/wire.rs#L999).
...
- **Decode** — [`HeaderSyncMessage::decode`](https://github.com/zakura-core/zakura/blob/f892b9074002a04a678ef2365ec7658795796572/crates/zakura-network/src/zakura/header_sync/wire.rs#L675)
...
- **Reservation**
  ...
  - remain live
- **Verify** — [`prepare_headers`](https://github.com/zakura-core/zakura/blob/f892b9074002a04a678ef2365ec7658795796572/crates/zakura-header-chain/src/validation/prepare/pipeline.rs#L85), the context-free header validator, over the
  ...
  [`header_sync_driver`](https://github.com/zakura-core/zakura/blob/f892b9074002a04a678ef2365ec7658795796572/crates/zakurad/src/commands/start/zakura/header_sync_driver.rs#L635). The individual rules live in
  [`validation::context_free`](https://github.com/zakura-core/zakura/blob/f892b9074002a04a678ef2365ec7658795796572/crates/zakura-header-chain/src/validation/context_free/mod.rs).

Page linkage is a reservation rule, not a context-free one. It holds against the sent locator and
receive cursor in the local reservation, so [`prepare_headers`](https://github.com/zakura-core/zakura/blob/f892b9074002a04a678ef2365ec7658795796572/crates/zakura-header-chain/src/validation/prepare/pipeline.rs#L85) cannot decide it.
...
transition planner performs those checks; [`prepare_headers`](https://github.com/zakura-core/zakura/blob/f892b9074002a04a678ef2365ec7658795796572/crates/zakura-header-chain/src/validation/prepare/pipeline.rs#L85) documents the split.

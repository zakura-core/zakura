...
// Conservative allowances for fixed pool and connection bookkeeping. They cover
// counters, shared handles and platform locks initialized on first use. Cold
// allocation tests measure the constructors and check that these charges cover
// the real peak allocation. Request records are charged by their actual layout.

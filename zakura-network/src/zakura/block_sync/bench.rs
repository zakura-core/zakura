...
pub struct BenchBodyFeeder {
    ...
    body_input_decoded_deep_bytes: Arc<AtomicU64>,
...
pub fn spawn_bench_sequencer(
    ...
    let body_input_decoded_deep_bytes = Arc::new(AtomicU64::new(0));
    ...
    BenchSequencerHandle {
        feeder: BenchBodyFeeder {
            ...
            body_input_decoded_deep_bytes: body_input_decoded_deep_bytes.clone(),
...
impl BenchBodyFeeder {
    ...
    pub async fn feed_body(
        ...
        let body = SequencedBody::new_queued(
            ...
            self.body_input_decoded_deep_bytes.clone(),
        );
...
impl BenchCommitter {
    ...
    pub fn emit_state_snapshot(&self) {
        ...
        let sequencer_input_decoded_deep_bytes =
            self.body_input_decoded_deep_bytes.load(Ordering::Relaxed);

...
class ApplyDiagnosticsTests(unittest.TestCase):
    def test_alert_distinguishes_reactor_work_from_commit_ownership(self):
        fleet = watchdog.Fleet(name="testnet", url="http://localhost/data", dashboard_url="http://localhost")
        row = {"name": "node", "health": "stale", "height": 4355419, "alert_diagnostics": {"metrics_available": True, "metrics": {

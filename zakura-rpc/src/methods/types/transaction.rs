...
impl TransactionTemplate<NegativeOrZero> {
    ...
    pub fn new_coinbase(
        ...
        // Use the process-wide Sapling prover, which caches its proving parameters to disk on
        // first use, instead of re-parsing the bundled parameters on every coinbase build.

...
1. **Start with an issue.** Check the [issue tracker](https://github.com/zakura-core/zakura/issues) for existing issues or create a new one describing what you want to change and why. **Wait for a team member to respond before writing code** — an issue with no team acknowledgment does not count as prior discussion.
2. **Coordinate large changes.** For anything beyond a small bug fix, discuss your approach with us via [issue tracker](https://github.com/zakura-core/zakura/issues) or [Discord](https://discord.gg/yVNhQwQE68) before opening a PR.
...
- Out of scope for Zakura (see above)

...
Pool, connection and receiver setup also reserve fixed allowances before they
allocate. Cold allocation tests check those allowances against actual allocation
peaks. A receiver replacement that cannot fund its setup leaves the current

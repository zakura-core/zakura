...
|  |  | ↳ `Block` — response item | [Specified](block-range.md#wire-format-contract) | [Sending specified](block-range.md#serving-model-contract); [receiving draft](block-range.md#draft-response-receiving-model) | [Covered by `GetBlocks`](block-range.md#regulated-load-contract) |
|  |  | ↳ `BlocksDone` — terminal response | [Specified](block-range.md#wire-format-contract) | [Sending specified](block-range.md#serving-model-contract); [receiving draft](block-range.md#draft-response-receiving-model) | [Covered by `GetBlocks`](block-range.md#regulated-load-contract) |
|  |  | ↳ `RangeUnavailable` — terminal response | [Specified](block-range.md#wire-format-contract) | [Sending specified](block-range.md#serving-model-contract); [receiving draft](block-range.md#draft-response-receiving-model) | [Covered by `GetBlocks`](block-range.md#regulated-load-contract) |

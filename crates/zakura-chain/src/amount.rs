...
///
/// ```
/// # use zakura_chain::amount::{Constraint, MAX_MONEY, NegativeAllowed};
/// assert_eq!(
...
///
/// ```
/// # use zakura_chain::amount::{Constraint, MAX_MONEY, NonNegative};
/// assert_eq!(
...
///
/// ```
/// # use zakura_chain::amount::{Constraint, MAX_MONEY, NegativeOrZero};
/// assert_eq!(

...
async fn run_checked(
    ...
    tracing::info!(
        ...
        peak_active_pipeline_decoded_deep_bytes = report.peak_active_pipeline_decoded_deep_bytes,
        final_active_pipeline_decoded_deep_bytes = report.final_active_pipeline_decoded_deep_bytes,
